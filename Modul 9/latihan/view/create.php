...
// displaying proper message for the user to seewhether the query executed perfectly or not
if (!$add_user) {
...
<input type="text" name="user" class="formcontrol" required>
</div>
<div class="form-group">
...
<input type="password" name="pass" class="formcontrol" required>
</div>
<div class="form-group">
